...
public class Angle {
    ...
    public Angle compl(Angle angle) {
        if (angle.degrees < 90) {
            double result = 90 - angle.degrees;
            this.setX(result);
        } else {
            System.out.println("Kąt nie ma dopełnienia, bo jest równy bądź większy niż 90°");
        }
        return this;
    }

    public Angle suppl(Angle angle){
        if (angle.degree(x) < 180) {
            double result = 180 - angle.degree(x);
            this.setX(result);
        } else {
            System.out.println("Kąt nie ma kąta przylegającego, bo jest równy bądź większy niż 180°");
        }
        return this;
    }
